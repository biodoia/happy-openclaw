...
- **Pacchetti osservati**: `cmd/attach`, `cmd/server`, `internal/version`

### Networking

- Listener su **`127.0.0.1:<porta>`** (mai `0.0.0.0` per servizi app).
- Hostname pubblici: **`happy-openclaw.braigo.dev`** (o sottodomini dedicati) tramite **aigoproxy**.
